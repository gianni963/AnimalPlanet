...
class Video extends Model
{
    ...
    public function getThumbnail()
    {
    	if(!$this->isProcessed()){
    		...
    		return config('petube.buckets.videos'). '/default_thumbnail.png';
    	}
    	return config('petube.buckets.videos'). '/' . $this->video_id . '_1.jpg';
    }
    ...
    {
        return config('petube.buckets.videos') . '/' . $this->video_id .'.mp4';
    }
    ...
    public function voteFromUserCollection(User $user)
    {
        return $this->votes->where('user_id', $user->id);
    }
